# Masih melanjutkan bagaimana menghandle missing value tentunya dengan jalan
# mengganti missing value dengan nilai lainnya.
# Pada bab sebelumnya telah mengganti kolom bertipe objek dengan sesuatu string/teks.
...
# apakah memiliki ouliers atau tidak. Jika ada outliers dari data maka menggunakan
# nilai tengah (median) data adalah cara yang lebih safe.
...
# Di sini pada kolom active data memiliki outliers. Jadi akan mengisi missing value dengan median.
