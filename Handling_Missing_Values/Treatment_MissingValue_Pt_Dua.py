...
# Meskipun ini lebih make sense dalam representasi datanya,
# tetapi untuk sub bab ini ketiga kolom tersebut diasumsikan dibiarkan memiliki nilai missing value.

# Treatment kedua yaitu dengan menghapus kolom, yang mana ini digunakan jika seluruh
# kolom dari dataset yang dipunyai semua barisnya adalah missing value.
# Untuk itu dapat menerapkan method .dropna() pada dataframe, bagaimana caranya?

# nama_dataframe.dropna(axis=1, how="all")

# Pada method .dropna() ada dua keyword argumen yang harus diisikan yaitu axis dan how.
# Keyword axis digunakan untuk menentukan arah dataframe yang akan dibuang,
# angka 1 untuk menyatakan kolom (column-based) atau dapat ditulis dalam string "column".
