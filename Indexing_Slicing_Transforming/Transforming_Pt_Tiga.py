...
# Method .apply() digunakan untuk menerapkan suatu fungsi python (yang dibuat dengan def atau
# anonymous dengan lambda) pada dataframe/series atau hanya kolom tertentu dari dataframe.
